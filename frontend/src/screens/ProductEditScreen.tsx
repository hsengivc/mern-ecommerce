...
import { listProductDetails, updateProduct } from "../store/actions";
import { ProductUpdateActions } from "../store/enums";
...
export const ProductEditScreen = ({
  ...
  } = useSelector((state: ReduxStates) => state.ProductUpdate);

  useEffect(() => {
    if (successUpdate) {
      dispatch({ type: ProductUpdateActions.PRODUCT_UPDATE_RESET });
